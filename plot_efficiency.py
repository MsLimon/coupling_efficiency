...
if __name__ == '__main__':
    ...
    for waveguide in waveguides:
        for laser in lasers:
            # now we make an instance of the efficiency calculator. That is, we bring together the information of the
            # laser diode and the waveguide, so that the program can calculate the coupling efficiency
